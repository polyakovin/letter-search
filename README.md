...
- `site/app.js`: browser UI, image loading and accessible zoom dialog.
- `src/services/demo.js`: pure round state, deadline and word checking.
- `content/`: five selected illustrations, provenance and generation prompts.
- `scripts/`: build, preview and integrity checks.
- `specs/001-bilingual-website/`: scope, acceptance, plan and validation.
