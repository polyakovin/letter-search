# Tasks
- [x] T001 Inspect clean Git root and existing website contract; create bounded spec/plan.
- [x] T002 Prepare six aligned localized annotation maps in content/annotations.js and locally licensed font under content/fonts/.
- [x] T003 Add focused geometry/catalog/slider tests and pure helpers in src/services/viewer.js and viewer.test.js.
